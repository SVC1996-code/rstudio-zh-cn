...
2. 从[正式 Release](https://github.com/SVC1996-code/rstudio-zh-cn/releases/tag/v2026.09.0%2B174-zh_CN-r1) 下载 `RStudio-2026.09.0+174-zh_CN-r1.zip`，可使用同页 `SHA256SUMS.txt` 核对摘要。
